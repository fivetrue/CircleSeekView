...
abstract public class AbsCircleSeekView extends View {
	 ...
	 * 도형 정보
	 */
	final protected int CIRCLE_DEGREE = 360;
	
	static protected int STROKE_BACKGROUND = 15;
	static protected int STROKE_BACKGROUND_COLOR = 0x77FFFFFF;
	
	static protected int STROKE_FOREGROUND = 5;
	static protected int STROKE_FOREGROUND_COLOR = 0xFFFFFFFF;
	
	static protected int STROKE_BAR_COLOR = 0xFFFFFFFF;
	
	static protected int TEXT_SIZE = 50;
	static protected int TEXT_COLOR = 0xFFFFFFFF;
	
	static protected int PADDING = 0;
	static protected boolean SHOWING_TOUCH_LINE = false;
...
//	private ArrayList<String> arr  = new ArrayList<String>();
	...
	private void drawSeekBar(Canvas canvas){
		...
		path.moveTo(x1, y1);
		path.lineTo(x2, y2);
		canvas.drawPath(path, mPaintSeekBar);
	}
